 ...
 * \return int retorna -1 si hubo un error, retorna el lugar libre si todo fue bien.
 *
 */
 ...
 * \param list Employee*
 * \param len int
 * \return int retorna 1 si algun dato del empleado se modifico, retorna 0 si no se modifico.
 *
 */
